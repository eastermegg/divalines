...
await page.evaluate(() => document.querySelector('[aria-labelledby="collection-title"]').scrollIntoView({ block: "center" }));
await page.waitForTimeout(2500);
await page.screenshot({ path: ".context/shots/collection.png" });
await browser.close();
console.log("saved");
