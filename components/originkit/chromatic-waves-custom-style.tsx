...
function __OriginkitBase_DottedBg2({
  frequency = 1,
  speed = 4,
  bgColor = "#000000",
  colors,
...
export default function DottedBg2(props: Record<string, unknown>) {
  return <__OriginkitBase_DottedBg2 {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
