...
// Originkit "wave-arcs" (nextjs/tailwind/ts variant), unmodified.
// Canvas of sweeping concentric arcs; pauses itself when hidden or
// offscreen (IntersectionObserver + visibilitychange).
...
function useCanvasAnimation({
  ...
  onDraw: (ctx: CanvasRenderingContext2D, state: CanvasState) => boolean | void;
